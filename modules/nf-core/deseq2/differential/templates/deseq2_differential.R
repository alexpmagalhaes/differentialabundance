...
if (!is.null(opt\$transcript_lengths_file)){
    lengths <-
        ...
        print("Checking matching between count.table and lengths")
                print("Checking colnames count.table:")

print(head(colnames(count.table)))
        print("Checking colnames length:")

print(head(colnames(lengths)))
print(setdiff(colnames(count.table), colnames(lengths)))  # Columns in count.table not in lengths
        print("Checking rownames count.table:")
print(head(rownames(lengths)))

        print("Checking dimnames dds:")

print(head(dimnames(dds)))
