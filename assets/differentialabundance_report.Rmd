    ...
    if (nrow(contrasts) > 1) {
        ...
        de_genes <- lapply(differential_results, function(de){
            ...
            if (!is.null(params$features) &&
                ...
                (params$differential_feature_name_column %in% colnames(de))) {
            ...
            sig <- de[!is.na(de[[label_col]]) &
                ...
                (log2(1/params$differential_min_fold_change) > de[[params$differential_fc_column]] | de[[params$differential_fc_column]] > log2(params$differential_min_fold_change)) &
