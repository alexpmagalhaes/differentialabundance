...
for (i in 1:nrow(contrasts)){
    ...
    for (pvt in names(p_value_types)){
        ...
        print(colnames(contrast_de))
        top_genes <- head(contrast_de[order(contrast_de$Padj), 1], 5)
        ...
        plot_df$Condition <- obs_sub[plot_df$Sample, "experiment_accession"]

        # Boxplot + jitter for each gene
