...
- [[#xxx](https://github.com/nf-core/differentialabundance/pull/xxx/)] - Volcano plot now shows gene name when hovering over points, review by [@grst](https://github.com/grst).
